...
public class ClickHouseStorageConfiguration implements IStorageConfiguration {
    ...
    @JsonCreator
    public ClickHouseStorageConfiguration(@JsonProperty("props") Map<String, Object> props,
