...
public class TraceStorage extends TraceJdbcStorage {
    ...
    public void initialize() {
        ...
        new TableCreator(config, dslContext).createIfNotExist(Tables.BITHON_TRACE_SPAN_SUMMARY);
        new TableCreator(config, dslContext).useReplacingMergeTree(true).createIfNotExist(Tables.BITHON_TRACE_MAPPING);
        new TableCreator(config, dslContext).createIfNotExist(Tables.BITHON_TRACE_SPAN_TAG_INDEX);
    }
