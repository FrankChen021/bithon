 ...
 */
public class GreaterOrEqualMetricCondition extends AbstractAbsoluteThresholdCondition {

    @JsonCreator
    public GreaterOrEqualMetricCondition(@JsonProperty("name") @NotNull String name,
    ...
    protected boolean matches(IValueType valueType, Number threshold, Number now) {
        return valueType.isGreaterThanOrEqual(now, threshold);
    }
