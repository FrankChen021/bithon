 ...
 */
public class LessOrEqualMetricCondition extends AbstractAbsoluteThresholdCondition {

    @JsonCreator
    public LessOrEqualMetricCondition(@JsonProperty("name") @NotNull String name,
