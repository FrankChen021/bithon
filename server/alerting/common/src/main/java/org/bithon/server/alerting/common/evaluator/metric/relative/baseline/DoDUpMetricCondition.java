 ...
 */
public class DoDUpMetricCondition extends AbstractBaselineMetricCondition {

    public DoDUpMetricCondition(@JsonProperty("name") @NotNull String name,
                                @JsonProperty("aggregator") @NotNull Aggregator aggregator,
                                @JsonProperty("dayOffset") @NotNull Integer dayOffset,
        ...
        super(name, aggregator, dayOffset, true, percentage, window, baseLineCacheManager);
    }
}
