 ...
 */
public class DoDUpPredicate extends AbstractBaselinePredicate {

    public DoDUpPredicate(@JsonProperty("dayBefore") @NotNull Integer dayBefore,
        ...
        super(dayBefore, true, percentage, baseLineCacheManager);
    }
}
