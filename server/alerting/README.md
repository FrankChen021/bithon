...
```mermaid
    flowchart TD
        alerting-admin -. Create/Delete Alert .-> Storage
        alerting-processor -. Read Alert .-> Storage
        alerting-processor -. Read Metrics .-> bithon-server
        alerting-processor -. Generate images .-> image-render-service
        alerting-processor -. Notification .-> external-application
```
