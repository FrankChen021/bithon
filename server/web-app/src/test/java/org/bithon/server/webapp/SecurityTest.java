...
public class SecurityTest {
    ...
    static class FakeHttpRequest implements HttpServletRequest {
        private final String uri;

        FakeHttpRequest(String uri) {
            this.uri = uri;
        }
    ...
    public void generateToken() {
        ...
        String jwt = component.createToken("frankchen@apache.org", Collections.emptyList(),
                                           ...
                                           Duration.ofDays(3650).getSeconds());
        Jws<Claims> token = component.decodeToken(jwt);
