...
const httpClientRequestsOption = {
  title: {
    text: '',
    subtext: '',
    show: false,
...
const httpClientErrorOption = {
  ...
  legend: {
    ...
    top: 0,
    data: [
      { name: '4xx', icon: 'circle' },
      { name: '5xx', icon: 'circle' },
      { name: 'Exception', icon: 'circle' },
    ],
  },
  dataZoom: {
    show: false,
...
const httpClientIoOption = {
  ...
  legend: {
    ...
    top: 0,
    data: [
      { name: 'Request Bytes', icon: 'circle' },
      { name: 'Response Bytes', icon: 'circle' }
    ],
  },
  dataZoom: {
    show: false,
