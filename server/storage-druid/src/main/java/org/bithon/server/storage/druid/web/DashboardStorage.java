...
package org.bithon.server.storage.druid.web;
...
import org.bithon.server.storage.druid.DruidConfig;
import org.bithon.server.storage.druid.DruidJooqContextHolder;
import org.bithon.server.storage.druid.TableCreator;
...
public class DashboardStorage extends JdbcDashboardStorage {
    ...
    @JsonCreator
    public DashboardStorage(@JacksonInject(useInput = OptBoolean.FALSE) DruidJooqContextHolder dslContextHolder,
