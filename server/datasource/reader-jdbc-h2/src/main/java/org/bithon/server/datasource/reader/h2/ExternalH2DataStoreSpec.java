...
public class ExternalH2DataStoreSpec extends ExternalDataStoreSpec {
    ...
    public IDataStoreSpec hideSensitiveInformation() {
        return new ExternalH2DataStoreSpec(this.getSensitiveHiddenProps(), this.store, this.sqlDialectManager, this.querySettings);
    }
    ...
    public IDataSourceReader createReader() {
        return new JdbcDataSourceReader(store,
                                        this.properties,
                                        sqlDialectManager.getSqlDialect("h2"),
                                        querySettings);
    }
}
