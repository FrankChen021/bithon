...
/**
 * Custom Jackson serializer for DoubleColumn that only serializes elements up to the size boundary.
 * This prevents serializing unused capacity in the underlying array.
 *
 * @author frank.chen021@outlook.com
 * @date 20/10/25
 */
public class DoubleColumnSerializer extends JsonSerializer<DoubleColumn> {
