 ...
 * @date 2025/2/8 16:57
 */
public class JmxBeanTable extends AbstractBaseTable implements IPushdownPredicateProvider {
    private final AgentServiceProxyFactory proxyFactory;

    public JmxBeanTable(AgentServiceProxyFactory proxyFactory) {
    ...
    protected Class<?> getRecordClazz() {
        return IJvmCommand.JmxBean.class;
    }
