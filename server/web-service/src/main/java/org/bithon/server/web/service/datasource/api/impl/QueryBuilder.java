    ...
    public static Query build(ISchema schema,
        ...
        for (QueryField field : query.getFields()) {
            if (field.getExpression() != null) {
                ...
                selectColumnList.add(new ResultColumn(new Expression(field.getExpression()), field.getName()));
            ...
            if (field.getAggregator() != null) {
                ...
                selectColumnList.add(new ResultColumn(function, field.getName()));
            } else {
                ...
                selectColumnList.add(resultColumn);
