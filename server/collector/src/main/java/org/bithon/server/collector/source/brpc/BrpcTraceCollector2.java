...
@Slf4j
@JsonTypeName("local")
public class BrpcTraceCollector2 implements ITraceCollector, AutoCloseable, ITraceMessageSource {
    ...
    @JsonCreator
    public BrpcTraceCollector2(@JacksonInject(useInput = OptBoolean.FALSE) ApplicationContext applicationContext) {
