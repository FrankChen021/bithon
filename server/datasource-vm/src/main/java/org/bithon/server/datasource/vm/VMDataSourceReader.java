...
public class VMDataSourceReader implements IDataSourceReader {
    ...
    public List<Map<String, Object>> timeseries(Query query) {
        ...
        IQueryApi.RangeQueryResponse response = queryApi.queryRange(ql.toString(),
        ...
        for (IQueryApi.SeriesData series : response.getData().getResult()) {
