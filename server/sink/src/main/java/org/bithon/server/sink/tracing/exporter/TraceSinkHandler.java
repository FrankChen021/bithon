 ...
 */
@Slf4j
public class TraceSinkHandler implements ITraceExporter {

    @Getter
    private final Handler handler;

    @JsonCreator
    public TraceSinkHandler(@JacksonInject(useInput = OptBoolean.FALSE) ApplicationContext applicationContext) {
