 ...
 * @date 2024/12/29 23:29
 */
public class EvaluationLogStorage extends EvaluationLogJdbcStorage {
    @JsonCreator
    public EvaluationLogStorage(@JacksonInject(useInput = OptBoolean.FALSE) JdbcStorageProviderConfiguration storageProvider,
    ...
    public void initialize() {
        ...
        TableCreator.createTableIfNotExists(dslContext, Tables.BITHON_ALERT_EVALUATION_LOG);
    }
}
