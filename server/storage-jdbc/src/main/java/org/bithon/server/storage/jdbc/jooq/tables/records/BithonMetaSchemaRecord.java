...
public class BithonMetaSchemaRecord extends TableRecordImpl<BithonMetaSchemaRecord> implements Record4<Timestamp, String, String, String> {

    private static final long serialVersionUID = 1649744016;
    ...
    @Override
    public BithonMetaSchemaRecord values(Timestamp value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BithonMetaSchemaRecord(Timestamp timestamp, String name, String schema, String signature) {
        super(BithonMetaSchema.BITHON_META_SCHEMA);
