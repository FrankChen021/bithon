...
public class BithonAgentSetting extends TableImpl<BithonAgentSettingRecord> {
     ...
     */
    public final TableField<BithonAgentSettingRecord, LocalDateTime> TIMESTAMP = createField(DSL.name("timestamp"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "Created Timestamp");
