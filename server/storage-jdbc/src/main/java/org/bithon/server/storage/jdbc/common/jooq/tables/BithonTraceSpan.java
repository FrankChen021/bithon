...
public class BithonTraceSpan extends TableImpl<BithonTraceSpanRecord> {
     ...
     */
    public final TableField<BithonTraceSpanRecord, LocalDateTime> TIMESTAMP = createField(DSL.name("timestamp"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "Milli Seconds");
