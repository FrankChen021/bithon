...
public class Indexes {
    ...
    public static final Index BITHON_TRACE_SPAN_SUMMARY_IDX_TSS_1_STARTTIME = Internal.createIndex(DSL.name("idx_tss_1_starttime"), BithonTraceSpanSummary.BITHON_TRACE_SPAN_SUMMARY, new OrderField[] { BithonTraceSpanSummary.BITHON_TRACE_SPAN_SUMMARY.STARTTIMEUS }, false);
