...
public class BithonAgentSettingRecord extends TableRecordImpl<BithonAgentSettingRecord> implements Record6<LocalDateTime, String, String, String, String, LocalDateTime> {

    private static final long serialVersionUID = -1426189875;
    ...
    @Override
    public BithonAgentSettingRecord value6(LocalDateTime value) {
        setUpdatedat(value);
        return this;
    }

    @Override
    public BithonAgentSettingRecord values(LocalDateTime value1, String value2, String value3, String value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BithonAgentSettingRecord(LocalDateTime timestamp, String appname, String settingname, String setting, String format, LocalDateTime updatedat) {
        super(BithonAgentSetting.BITHON_AGENT_SETTING);
