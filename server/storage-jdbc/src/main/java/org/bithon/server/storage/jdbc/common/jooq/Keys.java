...
public class Keys {
    ...
    public static final UniqueKey<BithonWebDashboardRecord> KEY_BITHON_WEB_DASHBOARD_IDX_WEB_DASHBOARD_ID = Internal.createUniqueKey(BithonWebDashboard.BITHON_WEB_DASHBOARD, DSL.name("KEY_bithon_web_dashboard_idx_web_dashboard_id"), new TableField[] { BithonWebDashboard.BITHON_WEB_DASHBOARD.ID }, true);
}
