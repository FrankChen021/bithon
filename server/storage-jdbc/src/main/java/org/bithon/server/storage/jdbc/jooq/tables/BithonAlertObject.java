...
public class BithonAlertObject extends TableImpl<BithonAlertObjectRecord> {
    ...
    private static final long serialVersionUID = -309364941;
     ...
     */
    public final TableField<BithonAlertObjectRecord, Timestamp> CREATED_AT = createField(DSL.name("created_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP(3)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>bithon_alert_object.updated_at</code>.
     */
    public final TableField<BithonAlertObjectRecord, Timestamp> UPDATED_AT = createField(DSL.name("updated_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP(3)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
