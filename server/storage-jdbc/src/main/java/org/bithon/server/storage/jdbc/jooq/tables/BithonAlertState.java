...
public class BithonAlertState extends TableImpl<BithonAlertStateRecord> {
    ...
    private static final long serialVersionUID = -392682299;
     ...
     */
    public final TableField<BithonAlertStateRecord, Timestamp> LAST_ALERT_AT = createField(DSL.name("last_alert_at"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
