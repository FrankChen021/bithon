...
public class BithonWebDashboardRecord extends TableRecordImpl<BithonWebDashboardRecord> implements Record5<Timestamp, String, String, String, Integer> {

    private static final long serialVersionUID = -1035803417;
    ...
    @Override
    public Row5<Timestamp, String, String, String, Integer> valuesRow() {
    ...
    @Override
    public BithonWebDashboardRecord value1(Timestamp value) {
        setTimestamp(value);
        return this;
    }
    ...
    @Override
    public BithonWebDashboardRecord values(Timestamp value1, String value2, String value3, String value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BithonWebDashboardRecord(Timestamp timestamp, String name, String payload, String signature, Integer deleted) {
        super(BithonWebDashboard.BITHON_WEB_DASHBOARD);
