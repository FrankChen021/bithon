...
(
    `timestamp`      TIMESTAMP   NOT NULL COMMENT 'Milli Seconds',
    `f1`             VARCHAR(64) COMMENT 'tag value1',
    `f2`             VARCHAR(64) COMMENT 'tag value2',
    `f3`             VARCHAR(64) COMMENT 'tag value3',
    `f4`             VARCHAR(64) COMMENT 'tag value4',
    `f5`             VARCHAR(64) COMMENT 'tag value5',
    `f6`             VARCHAR(64) COMMENT 'tag value6',
    `f7`             VARCHAR(64) COMMENT 'tag value7',
    `f8`             VARCHAR(64) COMMENT 'tag value8',
    `f9`             VARCHAR(64) COMMENT 'tag value9',
    `f10`            VARCHAR(64) COMMENT 'tag value10',
    `f11`            VARCHAR(64) COMMENT 'tag value11',
    `f12`            VARCHAR(64) COMMENT 'tag value12',
    `f13`            VARCHAR(64) COMMENT 'tag value13',
    `f14`            VARCHAR(64) COMMENT 'tag value14',
