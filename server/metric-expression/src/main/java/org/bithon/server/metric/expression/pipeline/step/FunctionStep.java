 ...
 * @date 2/6/25 9:29 pm
 */
public abstract class FunctionStep implements IQueryStep {
    private final IQueryStep source;

    public FunctionStep(IQueryStep source) {
        this.source = source;
    }
    ...
    public static FunctionStep apply(IQueryStep source, Function<PipelineQueryResult, PipelineQueryResult> function) {
        return new FunctionStep(source) {
            @Override
