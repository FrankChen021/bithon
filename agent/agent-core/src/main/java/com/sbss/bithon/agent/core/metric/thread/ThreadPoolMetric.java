package com.sbss.bithon.agent.core.metric.thread;
 ...
 */
public abstract class ThreadPoolMetric {
    ...
    public ThreadPoolMetric(String executorClass, String threadPoolName) {
