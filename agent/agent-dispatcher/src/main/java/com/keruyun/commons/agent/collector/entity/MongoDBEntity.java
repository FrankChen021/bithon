...
public class MongoDBEntity implements org.apache.thrift.TBase<MongoDBEntity, MongoDBEntity._Fields>, java.io.Serializable, Cloneable, Comparable<MongoDBEntity> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MongoDBEntity");
    ...
    private static final org.apache.thrift.protocol.TField COMMANDS_FIELD_DESC = new org.apache.thrift.protocol.TField("commands", org.apache.thrift.protocol.TType.I32, (short) 7);
    private static final org.apache.thrift.protocol.TField FAILURE_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("failureCount", org.apache.thrift.protocol.TType.I32, (short) 8);
    ...
    private static final org.apache.thrift.protocol.TField REQUEST_BYTE_SIZE_FIELD_DESC = new org.apache.thrift.protocol.TField("requestByteSize", org.apache.thrift.protocol.TType.I64, (short) 11);
    private static final org.apache.thrift.protocol.TField RESPONSE_BYTE_SIZE_FIELD_DESC = new org.apache.thrift.protocol.TField("responseByteSize", org.apache.thrift.protocol.TType.I64, (short) 12);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MongoDBEntityStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MongoDBEntityTupleSchemeFactory();
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        ...
        COMMANDS((short) 7, "commands"),
        FAILURE_COUNT((short) 8, "failureCount"),
        COST_TIME((short) 9, "costTime"),
        FLAG((short) 10, "flag"),
        REQUEST_BYTE_SIZE((short) 11, "requestByteSize"),
        RESPONSE_BYTE_SIZE((short) 12, "responseByteSize");
        ...
        public static _Fields findByThriftId(int fieldId) {
            switch (fieldId) {
                ...
                case 7: // COMMANDS
                    return COMMANDS;
                case 8: // FAILURE_COUNT
                    return FAILURE_COUNT;
                case 9: // COST_TIME
                    return COST_TIME;
                case 10: // FLAG
                    return FLAG;
                case 11: // REQUEST_BYTE_SIZE
                    return REQUEST_BYTE_SIZE;
                case 12: // RESPONSE_BYTE_SIZE
    ...
    private static final int __COMMANDS_ISSET_ID = 3;
    private static final int __FAILURECOUNT_ISSET_ID = 4;
    private static final int __COSTTIME_ISSET_ID = 5;
    private static final int __REQUESTBYTESIZE_ISSET_ID = 6;
    private static final int __RESPONSEBYTESIZE_ISSET_ID = 7;
    ...
    static {
        ...
        org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MongoDBEntity.class, metaDataMap);
    }
     ...
     */
    public MongoDBEntity(MongoDBEntity other) {
    ...
    public MongoDBEntity deepCopy() {
        return new MongoDBEntity(this);
    }
    ...
    public MongoDBEntity setAppName(String appName) {
        this.appName = appName;
        return this;
    }
    ...
    public MongoDBEntity setHostName(String hostName) {
        this.hostName = hostName;
        return this;
    }
    ...
    public MongoDBEntity setPort(int port) {
        this.port = port;
        setPortIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setHostPort(String hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public MongoDBEntity setTimestamp(long timestamp) {
        this.timestamp = timestamp;
        setTimestampIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setInterval(int interval) {
        this.interval = interval;
        setIntervalIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setCommands(int commands) {
        this.commands = commands;
        setCommandsIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setFailureCount(int failureCount) {
        this.failureCount = failureCount;
        setFailureCountIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setCostTime(long costTime) {
        this.costTime = costTime;
        setCostTimeIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setFlag(String flag) {
        this.flag = flag;
        return this;
    }
    ...
    public MongoDBEntity setRequestByteSize(long requestByteSize) {
        this.requestByteSize = requestByteSize;
        setRequestByteSizeIsSet(true);
        return this;
    }
    ...
    public MongoDBEntity setResponseByteSize(long responseByteSize) {
        this.responseByteSize = responseByteSize;
        setResponseByteSizeIsSet(true);
        return this;
    }
    ...
    public boolean equals(Object that) {
        if (that == null)
            return false;
        if (that instanceof MongoDBEntity)
            return this.equals((MongoDBEntity) that);
        return false;
    }

    public boolean equals(MongoDBEntity that) {
        if (that == null)
            return false;
        if (this == that)
            return true;
    ...
    @Override
    public int compareTo(MongoDBEntity other) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MongoDBEntity(");
        boolean first = true;
    ...
    private static class MongoDBEntityStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        public MongoDBEntityStandardScheme getScheme() {
            return new MongoDBEntityStandardScheme();
        }
    }

    private static class MongoDBEntityStandardScheme extends org.apache.thrift.scheme.StandardScheme<MongoDBEntity> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, MongoDBEntity struct) throws org.apache.thrift.TException {
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, MongoDBEntity struct) throws org.apache.thrift.TException {
            struct.validate();
    ...
    private static class MongoDBEntityTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        public MongoDBEntityTupleScheme getScheme() {
            return new MongoDBEntityTupleScheme();
        }
    }

    private static class MongoDBEntityTupleScheme extends org.apache.thrift.scheme.TupleScheme<MongoDBEntity> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, MongoDBEntity struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, MongoDBEntity struct) throws org.apache.thrift.TException {
