...
public class ServerInfoEntity implements org.apache.thrift.TBase<ServerInfoEntity, ServerInfoEntity._Fields>, java.io.Serializable, Cloneable, Comparable<ServerInfoEntity> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ServerInfoEntity");
  ...
  private static final org.apache.thrift.protocol.TField SERVER_METRIC_ENTITY_FIELD_DESC = new org.apache.thrift.protocol.TField("serverMetricEntity", org.apache.thrift.protocol.TType.STRUCT, (short)7);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ServerInfoEntityStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ServerInfoEntityTupleSchemeFactory();
  ...
  public ServerMetricEntity serverMetricEntity; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SERVER_METRIC_ENTITY((short)7, "serverMetricEntity"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // CATEGORY
          return CATEGORY;
        case 7: // SERVER_METRIC_ENTITY
          return SERVER_METRIC_ENTITY;
  ...
  static {
    ...
    tmpMap.put(_Fields.CATEGORY, new org.apache.thrift.meta_data.FieldMetaData("category", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.SERVER_METRIC_ENTITY, new org.apache.thrift.meta_data.FieldMetaData("serverMetricEntity", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "ServerMetricEntity")));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ServerInfoEntity.class, metaDataMap);
  }
  ...
  public ServerInfoEntity(
    ...
    int interval,
    String category,
    ServerMetricEntity serverMetricEntity)
  {
    this();
    ...
    this.serverMetricEntity = serverMetricEntity;
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ServerInfoEntity(ServerInfoEntity other) {
    ...
    if (other.isSetServerMetricEntity()) {
      this.serverMetricEntity = new ServerMetricEntity(other.serverMetricEntity);
    }
    this.GranularityType = other.GranularityType;
  }

  public ServerInfoEntity deepCopy() {
    return new ServerInfoEntity(this);
  }
  ...
  public ServerInfoEntity setAppName(String appName) {
    this.appName = appName;
    return this;
  }
  ...
  public ServerInfoEntity setHostName(String hostName) {
    this.hostName = hostName;
    return this;
  }
  ...
  public ServerInfoEntity setPort(int port) {
    this.port = port;
    setPortIsSet(true);
    return this;
  }
  ...
  public ServerInfoEntity setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public ServerInfoEntity setInterval(int interval) {
    this.interval = interval;
    setIntervalIsSet(true);
    return this;
  }
  ...
  public ServerInfoEntity setCategory(String category) {
    this.category = category;
    return this;
  }
  ...
  public ServerMetricEntity getServerMetricEntity() {
    return this.serverMetricEntity;
  }

  public ServerInfoEntity setServerMetricEntity(ServerMetricEntity serverMetricEntity) {
    this.serverMetricEntity = serverMetricEntity;
    return this;
  }

  public void unsetServerMetricEntity() {
    this.serverMetricEntity = null;
  }

  /** Returns true if field serverMetricEntity is set (has been assigned a value) and false otherwise */
  public boolean isSetServerMetricEntity() {
    return this.serverMetricEntity != null;
  }

  public void setServerMetricEntityIsSet(boolean value) {
    if (!value) {
      this.serverMetricEntity = null;
    }
  }
  ...
  public ServerInfoEntity setGranularityType(int GranularityType) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SERVER_METRIC_ENTITY:
      if (value == null) {
        unsetServerMetricEntity();
      } else {
        setServerMetricEntity((ServerMetricEntity)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case SERVER_METRIC_ENTITY:
      return isSetServerMetricEntity();
    case GRANULARITY_TYPE:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ServerInfoEntity)
      return this.equals((ServerInfoEntity)that);
    return false;
  }

  public boolean equals(ServerInfoEntity that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_serverMetricEntity = true && this.isSetServerMetricEntity();
    boolean that_present_serverMetricEntity = true && that.isSetServerMetricEntity();
    if (this_present_serverMetricEntity || that_present_serverMetricEntity) {
      if (!(this_present_serverMetricEntity && that_present_serverMetricEntity))
        return false;
      if (!this.serverMetricEntity.equals(that.serverMetricEntity))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetServerMetricEntity()) ? 131071 : 524287);
    if (isSetServerMetricEntity())
      hashCode = hashCode * 8191 + serverMetricEntity.hashCode();
  ...
  @Override
  public int compareTo(ServerInfoEntity other) {
    ...
    lastComparison = Boolean.valueOf(isSetServerMetricEntity()).compareTo(other.isSetServerMetricEntity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServerMetricEntity()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serverMetricEntity, other.serverMetricEntity);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ServerInfoEntity(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("serverMetricEntity:");
    if (this.serverMetricEntity == null) {
      sb.append("null");
    } else {
      sb.append(this.serverMetricEntity);
    }
    first = false;
    if (isSetGranularityType()) {
      if (!first) sb.append(", ");
  ...
  private static class ServerInfoEntityStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ServerInfoEntityStandardScheme getScheme() {
      return new ServerInfoEntityStandardScheme();
    }
  }

  private static class ServerInfoEntityStandardScheme extends org.apache.thrift.scheme.StandardScheme<ServerInfoEntity> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ServerInfoEntity struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 7: // SERVER_METRIC_ENTITY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.serverMetricEntity = new ServerMetricEntity();
              struct.serverMetricEntity.read(iprot);
              struct.setServerMetricEntityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServerInfoEntity struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.serverMetricEntity != null) {
        oprot.writeFieldBegin(SERVER_METRIC_ENTITY_FIELD_DESC);
        struct.serverMetricEntity.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ServerInfoEntityTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ServerInfoEntityTupleScheme getScheme() {
      return new ServerInfoEntityTupleScheme();
    }
  }

  private static class ServerInfoEntityTupleScheme extends org.apache.thrift.scheme.TupleScheme<ServerInfoEntity> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ServerInfoEntity struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetServerMetricEntity()) {
        optionals.set(6);
      }
      if (struct.isSetGranularityType()) {
        optionals.set(7);
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ServerInfoEntity struct) throws org.apache.thrift.TException {
