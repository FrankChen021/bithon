 ...
 */
public class SenderMetrics$RecordRetries extends AfterInterceptor {

    private final ProducerMetricRegistry metricRegistry = MetricRegistryFactory.getOrCreateRegistry("kafka-producer",
