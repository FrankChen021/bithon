 ...
 */
public class ConnectionMessageReceivedEvent$Ctor extends AfterInterceptor {
    private static final ILogAdaptor log = LoggerFactory.getLogger(ConnectionMessageReceivedEvent$Ctor.class);
