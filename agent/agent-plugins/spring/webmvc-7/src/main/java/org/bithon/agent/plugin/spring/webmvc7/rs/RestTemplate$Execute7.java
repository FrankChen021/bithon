...
/**
 * Spring 7-compatible {@link org.springframework.web.client.RestTemplate#doExecute}.
 *
 * @author frankchen
 */
public class RestTemplate$Execute7 extends AroundInterceptor {
    @Override
    public InterceptionDecision before(AopContext aopContext) {
        ...
        HttpMethod method = (HttpMethod) aopContext.getArgs()[2];
