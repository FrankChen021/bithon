...
package org.bithon.agent.plugin.spring.webmvc7.controller;
 ...
 * @author frankchen
 */
public class InvocableHandlerMethod$DoInvoke7 extends AroundInterceptor {
    ...
    private void traceStreamingResponseBody(AopContext aopContext, ITraceSpan parentSpan) {
        ...
        if (returnValue instanceof StreamingResponseBody) {
            ...
            try {
                ...
                LoggerFactory.getLogger(InvocableHandlerMethod$DoInvoke7.class)
