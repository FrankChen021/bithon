...
public class BeanMethodInterceptorFactory {
    ...
    private static final String INTERCEPTOR_CLASS_NAME = "com.sbss.bithon.agent.plugin.spring.bean.BeanMethodInterceptorImpl";

    private static BeanMethodInterceptorIntf interceptorInstance;

    public static BeanMethodInterceptorIntf getOrCreate() {
        ...
        try {
            ...
            synchronized (INTERCEPTOR_CLASS_NAME) {
                ...
                interceptorInstance = (BeanMethodInterceptorIntf) interceptorClass.newInstance();
            }
