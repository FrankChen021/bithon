...
/**
 * {@link io.prestosql.jdbc.PrestoPreparedStatement#execute()}
 * {@link io.prestosql.jdbc.PrestoPreparedStatement#executeQuery()}
 * {@link io.prestosql.jdbc.PrestoPreparedStatement#executeUpdate()}
 *
 * @author frankchen
 */
public class PrestoPreparedStatement$Execute extends AbstractStatement$Execute {

    /**
     * The executing statement is injected by {@link PrestoPreparedStatement$Ctor}
     */
    @Override
