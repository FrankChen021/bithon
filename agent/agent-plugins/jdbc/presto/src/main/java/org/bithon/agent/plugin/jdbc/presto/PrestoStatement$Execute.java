...
/**
 * Hook on execute methods implemented in {@link io.prestosql.jdbc.PrestoStatement} as
 ...
 * @author frankchen
 */
public class PrestoStatement$Execute extends AbstractStatement$Execute {
    @Override
