...
public class RequestCounter implements IAgentCounter {
    ...
    private void createOrMerge(Object o) {
        ...
        Request request = (Request) afterJoinPoint.getArgs()[0];
        Response response = (Response) afterJoinPoint.getArgs()[1];
        ...
        log.debug("tomcat get failure40xCount {},failure50xCount {},requestByteSize {},responseByteSize {}",
                  failure40xCount,
                  failure50xCount,
                  requestByteSize,
                  responseByteSize);
