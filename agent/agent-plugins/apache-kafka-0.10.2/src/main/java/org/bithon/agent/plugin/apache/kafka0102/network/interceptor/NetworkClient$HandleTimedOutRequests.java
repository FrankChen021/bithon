...
package org.bithon.agent.plugin.apache.kafka0102.network.interceptor;
...
/**
 * {@link org.apache.kafka.clients.NetworkClient#handleTimedOutRequests(List, long)}
 *
...
public class NetworkClient$HandleTimedOutRequests extends NetworkClient$CompleteResponses {
    ...
    protected ApiKeys getResponseApiKeys(ClientResponse response) {
        short key = response.requestHeader().apiKey();
