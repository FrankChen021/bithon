package com.sbss.bithon.agent.plugin.alibaba.druid;
            ...
            forClass("com.alibaba.druid.pool.DruidDataSource")
                ...
                .methods(
                    MethodPointCutDescriptorBuilder.build()
                        ...
                        .to("com.sbss.bithon.agent.plugin.alibaba.druid.interceptor.DruidDataSourceInit"),

                    MethodPointCutDescriptorBuilder.build()
                        .onMethodAndNoArgs("close")
                        .to("com.sbss.bithon.agent.plugin.alibaba.druid.interceptor.DruidDataSourceClose"),

                    MethodPointCutDescriptorBuilder.build()
                        .onMethodAndNoArgs("restart")
                        .to("com.sbss.bithon.agent.plugin.alibaba.druid.interceptor.DruidDataSourceRestart"),

                    MethodPointCutDescriptorBuilder.build()
                        .onAllMethods("getStatValueAndReset")
                        .to("com.sbss.bithon.agent.plugin.alibaba.druid.interceptor.DruidDataSourceGetValueAndReset")
                ),
            ...
            forClass("com.alibaba.druid.pool.DruidPooledPreparedStatement")
                .methods(
                    MethodPointCutDescriptorBuilder.build()
                        ...
                        .to("com.sbss.bithon.agent.plugin.alibaba.druid.interceptor.DruidSqlInterceptor"),
