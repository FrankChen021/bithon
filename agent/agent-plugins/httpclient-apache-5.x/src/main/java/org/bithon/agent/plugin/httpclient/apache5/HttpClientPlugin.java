...
package org.bithon.agent.plugin.httpclient.apache5;
            ...
            forClass("org.apache.hc.client5.http.impl.classic.InternalHttpClient")
                .methods(
                    MethodPointCutDescriptorBuilder.build()
                                                   ...
                                                   .to("org.bithon.agent.plugin.httpclient.apache5.interceptor.InternalHttpClient$DoExecute")
                        ),
            ...
            forClass("org.apache.hc.core5.http.impl.io.HttpRequestExecutor")
                .methods(
                    MethodPointCutDescriptorBuilder.build()
                                                   ...
                                                   .to("org.bithon.agent.plugin.httpclient.apache5.interceptor.HttpRequestExecutor$Execute")
                        ),
            ...
            forClass("org.apache.hc.client5.http.impl.io.DefaultHttpClientConnectionOperator")
                .methods(
                    MethodPointCutDescriptorBuilder.build()
                                                   ...
                                                   .to("org.bithon.agent.plugin.httpclient.apache5.interceptor.DefaultHttpClientConnectionOperator$Connect")
                        ));
    }
}
