...
package org.bithon.agent.plugin.apache.kafka39.consumer.interceptor;
...
/**
 * {@link org.apache.kafka.clients.consumer.internals.ClassicKafkaConsumer#ClassicKafkaConsumer(ConsumerConfig, Deserializer, Deserializer)}
 *
 * @author frank.chen021@outlook.com
 * @date 2022/11/16 11:32
 */
public class ClassicKafkaConsumer$Ctor extends AfterInterceptor {
    ...
    public void after(AopContext aopContext) {
        ...
        if (!setContextOnNetworkClient(kafkaPluginContext, consumerNetworkClient)) {
            ...
            if ("LegacyKafkaConsumer".equals(clazzName)
                ...
                LoggerFactory.getLogger(ClassicKafkaConsumer$Ctor.class)
