 ...
 */
public class SpringBeanInterceptor extends AbstractInterceptor {

    @Override
    public InterceptionDecision onMethodEnter(AopContext aopContext) {
        // create a span and save it in user-context
        aopContext.setUserContext(TraceSpanBuilder.build("SpringBean")
    ...
    public void onMethodLeave(AopContext aopContext) {
        ((TraceSpan) aopContext.castUserContextAs()).tag(aopContext.getException())
                                                    .finish();
    }
}
