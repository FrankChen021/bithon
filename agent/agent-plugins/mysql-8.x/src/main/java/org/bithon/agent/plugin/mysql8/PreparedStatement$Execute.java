 ...
 * @author frankchen
 */
public class PreparedStatement$Execute extends AroundInterceptor {
    ...
    public void after(AopContext aopContext) {
        ...
        if (traceContext != null) {
            traceContext.currentSpan()
                        .tag(Tags.Database.STATEMENT, ((PreparedQuery) ((JdbcStatement) aopContext.getTarget()).getQuery()).getOriginalSql())
                        .finish();
        }
