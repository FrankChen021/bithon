...
/**
 * Description : log4j2 handler, intercept log action
 * <br>Date: 18/4/13
 *
 * @author 马至远
 */
public class Log4j2Handler extends AbstractMethodIntercepted {
    private static final String LOG4J2_PLUGIN = "log4j2";
    ...
    public boolean init() throws Exception {
        ...
        counterRepository.register(LOG4J2_PLUGIN, counter);
