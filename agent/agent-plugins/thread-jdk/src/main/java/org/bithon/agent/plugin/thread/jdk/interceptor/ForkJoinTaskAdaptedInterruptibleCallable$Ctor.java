...
/**
 * Hook on {@link java.util.concurrent.ForkJoinTask.AdaptedInterruptibleCallable#AdaptedInterruptibleCallable(Callable)}
 *
 * <p>
 ...
 */
public class ForkJoinTaskAdaptedInterruptibleCallable$Ctor extends AfterInterceptor {

    @Override
    public void after(AopContext aopContext) {
        Callable<?> callable = aopContext.getArgAs(0);

        IBithonObject task = aopContext.getTargetAs();
        task.setInjectedObject(new ForkJoinTaskContext(callable.getClass().getName(), "call"));
    }
}
