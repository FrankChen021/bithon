...
import org.bithon.agent.plugin.httpserver.jetty12.Jetty12Plugin;
...
/**
 * Test case for Jetty 12 HTTP server plugin.
 *
 * @author frankchen
 */
@EnabledForJreRange(min = JRE.JAVA_17)
public class Jetty12PluginInterceptorTest extends AbstractPluginInterceptorTest {
    @Override
    protected IPlugin[] getPlugins() {
        return new IPlugin[]{new Jetty12Plugin()};
    }
