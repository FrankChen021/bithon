...
public class GcEntity implements org.apache.thrift.TBase<GcEntity, GcEntity._Fields>, java.io.Serializable, Cloneable, Comparable<GcEntity> {
  ...
  private static final org.apache.thrift.protocol.TField GC_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("gcCount", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  public int compareTo(GcEntity other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGcName()).compareTo(other.isSetGcName());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGcCount()).compareTo(other.isSetGcCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGcCount()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGcTime()).compareTo(other.isSetGcTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGcTime()) {
