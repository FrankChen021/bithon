...
public class WebServerMessage implements org.apache.thrift.TBase<WebServerMessage, WebServerMessage._Fields>, java.io.Serializable, Cloneable, Comparable<WebServerMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WebServerMessage");
  ...
  private static final org.apache.thrift.protocol.TField SERVER_ENTITY_FIELD_DESC = new org.apache.thrift.protocol.TField("serverEntity", org.apache.thrift.protocol.TType.STRUCT, (short)7);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new WebServerMessageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new WebServerMessageTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable WebServerEntity serverEntity; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SERVER_ENTITY((short)7, "serverEntity");
  ...
  static {
    ...
    tmpMap.put(_Fields.SERVER_ENTITY, new org.apache.thrift.meta_data.FieldMetaData("serverEntity", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "WebServerEntity")));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WebServerMessage.class, metaDataMap);
  }

  public WebServerMessage() {
  }
   ...
   */
  public WebServerMessage(WebServerMessage other) {
    ...
    if (other.isSetServerEntity()) {
      this.serverEntity = new WebServerEntity(other.serverEntity);
    }
  }

  public WebServerMessage deepCopy() {
    return new WebServerMessage(this);
  }
  ...
  public WebServerMessage setAppName(@org.apache.thrift.annotation.Nullable java.lang.String appName) {
    this.appName = appName;
    return this;
  }
  ...
  public WebServerMessage setEnv(@org.apache.thrift.annotation.Nullable java.lang.String env) {
    this.env = env;
    return this;
  }
  ...
  public WebServerMessage setHostName(@org.apache.thrift.annotation.Nullable java.lang.String hostName) {
    this.hostName = hostName;
    return this;
  }
  ...
  public WebServerMessage setPort(int port) {
    this.port = port;
    setPortIsSet(true);
    return this;
  }
  ...
  public WebServerMessage setInterval(int interval) {
    this.interval = interval;
    setIntervalIsSet(true);
    return this;
  }
  ...
  public WebServerMessage setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public WebServerEntity getServerEntity() {
    return this.serverEntity;
  }

  public WebServerMessage setServerEntity(@org.apache.thrift.annotation.Nullable WebServerEntity serverEntity) {
    this.serverEntity = serverEntity;
    return this;
  }

  public void unsetServerEntity() {
    this.serverEntity = null;
  }

  /** Returns true if field serverEntity is set (has been assigned a value) and false otherwise */
  public boolean isSetServerEntity() {
    return this.serverEntity != null;
  }

  public void setServerEntityIsSet(boolean value) {
    if (!value) {
      this.serverEntity = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SERVER_ENTITY:
      if (value == null) {
        ...
        setServerEntity((WebServerEntity)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof WebServerMessage)
      return this.equals((WebServerMessage)that);
    return false;
  }

  public boolean equals(WebServerMessage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_serverEntity = true && this.isSetServerEntity();
    boolean that_present_serverEntity = true && that.isSetServerEntity();
    if (this_present_serverEntity || that_present_serverEntity) {
      if (!(this_present_serverEntity && that_present_serverEntity))
        return false;
      if (!this.serverEntity.equals(that.serverEntity))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetServerEntity()) ? 131071 : 524287);
    if (isSetServerEntity())
      hashCode = hashCode * 8191 + serverEntity.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(WebServerMessage other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetServerEntity()).compareTo(other.isSetServerEntity());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServerEntity()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serverEntity, other.serverEntity);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("WebServerMessage(");
    boolean first = true;
  ...
  private static class WebServerMessageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WebServerMessageStandardScheme getScheme() {
      return new WebServerMessageStandardScheme();
    }
  }

  private static class WebServerMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<WebServerMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WebServerMessage struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 7: // SERVER_ENTITY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.serverEntity = new WebServerEntity();
              struct.serverEntity.read(iprot);
              struct.setServerEntityIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WebServerMessage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      if (struct.serverEntity != null) {
        oprot.writeFieldBegin(SERVER_ENTITY_FIELD_DESC);
        struct.serverEntity.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class WebServerMessageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WebServerMessageTupleScheme getScheme() {
      return new WebServerMessageTupleScheme();
    }
  }

  private static class WebServerMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<WebServerMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WebServerMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WebServerMessage struct) throws org.apache.thrift.TException {
