...
public class FetchRequest implements org.apache.thrift.TBase<FetchRequest, FetchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FetchRequest> {
  ...
  public int compareTo(FetchRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEnvName()).compareTo(other.isSetEnvName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnvName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSince()).compareTo(other.isSetSince());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSince()) {
