...
public class JvmMetricMessage implements org.apache.thrift.TBase<JvmMetricMessage, JvmMetricMessage._Fields>, java.io.Serializable, Cloneable, Comparable<JvmMetricMessage> {
  ...
  public int compareTo(JvmMetricMessage other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDirectMax(), other.isSetDirectMax());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDirectMax()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDirectUsed(), other.isSetDirectUsed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDirectUsed()) {
