...
public class ClassEntity implements org.apache.thrift.TBase<ClassEntity, ClassEntity._Fields>, java.io.Serializable, Cloneable, Comparable<ClassEntity> {
  ...
  public int compareTo(ClassEntity other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetClasses(), other.isSetClasses());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLoaded(), other.isSetLoaded());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLoaded()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUnloaded(), other.isSetUnloaded());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUnloaded()) {
