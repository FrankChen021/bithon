...
public class HttpClientMessage implements org.apache.thrift.TBase<HttpClientMessage, HttpClientMessage._Fields>, java.io.Serializable, Cloneable, Comparable<HttpClientMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HttpClientMessage");
  ...
  private static final org.apache.thrift.protocol.TField HTTP_CLIENT_FIELD_DESC = new org.apache.thrift.protocol.TField("httpClient", org.apache.thrift.protocol.TType.STRUCT, (short)7);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new HttpClientMessageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new HttpClientMessageTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable HttpClientEntity httpClient; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    HTTP_CLIENT((short)7, "httpClient");
  ...
  static {
    ...
    tmpMap.put(_Fields.HTTP_CLIENT, new org.apache.thrift.meta_data.FieldMetaData("httpClient", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "HttpClientEntity")));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HttpClientMessage.class, metaDataMap);
  }
   ...
   */
  public HttpClientMessage(HttpClientMessage other) {
    ...
    if (other.isSetHttpClient()) {
      this.httpClient = new HttpClientEntity(other.httpClient);
    }
  }

  public HttpClientMessage deepCopy() {
    return new HttpClientMessage(this);
  }
  ...
  public HttpClientMessage setAppName(@org.apache.thrift.annotation.Nullable java.lang.String appName) {
    this.appName = appName;
    return this;
  }
  ...
  public HttpClientMessage setEnv(@org.apache.thrift.annotation.Nullable java.lang.String env) {
    this.env = env;
    return this;
  }
  ...
  public HttpClientMessage setHostName(@org.apache.thrift.annotation.Nullable java.lang.String hostName) {
    this.hostName = hostName;
    return this;
  }
  ...
  public HttpClientMessage setPort(int port) {
    this.port = port;
    setPortIsSet(true);
    return this;
  }
  ...
  public HttpClientMessage setInterval(int interval) {
    this.interval = interval;
    setIntervalIsSet(true);
    return this;
  }
  ...
  public HttpClientMessage setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public HttpClientEntity getHttpClient() {
    return this.httpClient;
  }

  public HttpClientMessage setHttpClient(@org.apache.thrift.annotation.Nullable HttpClientEntity httpClient) {
    this.httpClient = httpClient;
    return this;
  }

  public void unsetHttpClient() {
    this.httpClient = null;
  }

  /** Returns true if field httpClient is set (has been assigned a value) and false otherwise */
  public boolean isSetHttpClient() {
    return this.httpClient != null;
  }

  public void setHttpClientIsSet(boolean value) {
    if (!value) {
      this.httpClient = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case HTTP_CLIENT:
      if (value == null) {
        ...
        setHttpClient((HttpClientEntity)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof HttpClientMessage)
      return this.equals((HttpClientMessage)that);
    return false;
  }

  public boolean equals(HttpClientMessage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_httpClient = true && this.isSetHttpClient();
    boolean that_present_httpClient = true && that.isSetHttpClient();
    if (this_present_httpClient || that_present_httpClient) {
      if (!(this_present_httpClient && that_present_httpClient))
        return false;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetHttpClient()) ? 131071 : 524287);
    if (isSetHttpClient())
      hashCode = hashCode * 8191 + httpClient.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(HttpClientMessage other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHttpClient()).compareTo(other.isSetHttpClient());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHttpClient()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.httpClient, other.httpClient);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("HttpClientMessage(");
    boolean first = true;
  ...
  private static class HttpClientMessageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HttpClientMessageStandardScheme getScheme() {
      return new HttpClientMessageStandardScheme();
    }
  }

  private static class HttpClientMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<HttpClientMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HttpClientMessage struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 7: // HTTP_CLIENT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.httpClient = new HttpClientEntity();
              struct.httpClient.read(iprot);
              struct.setHttpClientIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HttpClientMessage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      if (struct.httpClient != null) {
        oprot.writeFieldBegin(HTTP_CLIENT_FIELD_DESC);
        struct.httpClient.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class HttpClientMessageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public HttpClientMessageTupleScheme getScheme() {
      return new HttpClientMessageTupleScheme();
    }
  }

  private static class HttpClientMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<HttpClientMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HttpClientMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HttpClientMessage struct) throws org.apache.thrift.TException {
