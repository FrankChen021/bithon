...
public class ITraceCollector {

  public interface Iface {

    public void sendTrace(MessageHeader header, java.util.List<TraceSpanMessage> spans) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void sendTrace(MessageHeader header, java.util.List<TraceSpanMessage> spans, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sendTrace(MessageHeader header, java.util.List<TraceSpanMessage> spans) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sendTrace_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public sendTrace_call(MessageHeader header, java.util.List<TraceSpanMessage> spans, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<java.lang.String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<java.lang.String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      processMap.put("sendTrace", new sendTrace());
      return processMap;
    }

    public static class sendTrace<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sendTrace_args> {
      public sendTrace() {
        super("sendTrace");
      }

      public sendTrace_args getEmptyArgsInstance() {
        return new sendTrace_args();
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sendTrace<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendTrace_args, Void> {
      public sendTrace() {
        super("sendTrace");
      }
  ...
  public static class sendTrace_args implements org.apache.thrift.TBase<sendTrace_args, sendTrace_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendTrace_args>   {
    ...
    public sendTrace_args deepCopy() {
      return new sendTrace_args(this);
    }
    ...
    public sendTrace_args setHeader(@org.apache.thrift.annotation.Nullable MessageHeader header) {
      this.header = header;
      return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
      if (that instanceof sendTrace_args)
        return this.equals((sendTrace_args)that);
      return false;
    }

    public boolean equals(sendTrace_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(sendTrace_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetSpans(), other.isSetSpans());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSpans()) {
    ...
    private static class sendTrace_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public sendTrace_argsStandardScheme getScheme() {
        return new sendTrace_argsStandardScheme();
      }
    }

    private static class sendTrace_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<sendTrace_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, sendTrace_args struct) throws org.apache.thrift.TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendTrace_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class sendTrace_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public sendTrace_argsTupleScheme getScheme() {
        return new sendTrace_argsTupleScheme();
      }
    }

    private static class sendTrace_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<sendTrace_args> {
