 ...
 *  @generated
 */
package org.bithon.agent.rpc.thrift.service.trace;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
public class TraceSpanMessage implements org.apache.thrift.TBase<TraceSpanMessage, TraceSpanMessage._Fields>, java.io.Serializable, Cloneable, Comparable<TraceSpanMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TraceSpanMessage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TraceSpanMessageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TraceSpanMessageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TraceSpanMessage.class, metaDataMap);
  }

  public TraceSpanMessage() {
  }
   ...
   */
  public TraceSpanMessage(TraceSpanMessage other) {
  ...
  public TraceSpanMessage deepCopy() {
    return new TraceSpanMessage(this);
  }
  ...
  public TraceSpanMessage setTraceId(@org.apache.thrift.annotation.Nullable java.lang.String traceId) {
    this.traceId = traceId;
    return this;
  }
  ...
  public TraceSpanMessage setSpanId(@org.apache.thrift.annotation.Nullable java.lang.String spanId) {
    this.spanId = spanId;
    return this;
  }
  ...
  public TraceSpanMessage setParentSpanId(@org.apache.thrift.annotation.Nullable java.lang.String parentSpanId) {
    this.parentSpanId = parentSpanId;
    return this;
  }
  ...
  public TraceSpanMessage setParentAppName(@org.apache.thrift.annotation.Nullable java.lang.String parentAppName) {
    this.parentAppName = parentAppName;
    return this;
  }
  ...
  public TraceSpanMessage setKind(@org.apache.thrift.annotation.Nullable java.lang.String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public TraceSpanMessage setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TraceSpanMessage setClazz(@org.apache.thrift.annotation.Nullable java.lang.String clazz) {
    this.clazz = clazz;
    return this;
  }
  ...
  public TraceSpanMessage setMethod(@org.apache.thrift.annotation.Nullable java.lang.String method) {
    this.method = method;
    return this;
  }
  ...
  public TraceSpanMessage setTags(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public TraceSpanMessage setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
  ...
  public TraceSpanMessage setEndTime(long endTime) {
    this.endTime = endTime;
    setEndTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TraceSpanMessage)
      return this.equals((TraceSpanMessage)that);
    return false;
  }

  public boolean equals(TraceSpanMessage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TraceSpanMessage other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetParentAppName(), other.isSetParentAppName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParentAppName()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetClazz(), other.isSetClazz());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClazz()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TraceSpanMessage(");
    boolean first = true;
  ...
  private static class TraceSpanMessageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TraceSpanMessageStandardScheme getScheme() {
      return new TraceSpanMessageStandardScheme();
    }
  }

  private static class TraceSpanMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TraceSpanMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TraceSpanMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TraceSpanMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TraceSpanMessageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TraceSpanMessageTupleScheme getScheme() {
      return new TraceSpanMessageTupleScheme();
    }
  }

  private static class TraceSpanMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TraceSpanMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TraceSpanMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TraceSpanMessage struct) throws org.apache.thrift.TException {
